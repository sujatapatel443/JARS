...
@WebServlet("/showregister.ntt")
public class ShowRegisterServlet extends HttpServlet{
	
	@Override
	protected void service(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		System.out.println("-----service method() of ShowRegisterServlet started-----");
		...
		rd2.include(req, res);
		RequestDispatcher rd3=req.getRequestDispatcher("/WEB-INF/register.html");
		rd3.include(req, res);
		RequestDispatcher rd4=req.getRequestDispatcher("/WEB-INF/footer.html");
		rd4.include(req, res);
		System.out.println("----service methoid() of ShowRegisterServlet completed");
