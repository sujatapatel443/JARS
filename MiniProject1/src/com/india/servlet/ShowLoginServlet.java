...
@WebServlet("/showlogin.jlc")
public class ShowLoginServlet extends HttpServlet{
	
	@Override
	protected void service(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		System.out.println("service() Of ShowLoginServlet started...");
		...
		RequestDispatcher rd3=req.getRequestDispatcher("/WEB-INF/login.html"); rd3.include(req, res);
		RequestDispatcher rd4=req.getRequestDispatcher("/WEB-INF/footer.html"); rd4.include(req, res);
		
		System.out.println("service() Of ShowLoginServlet completed...");
