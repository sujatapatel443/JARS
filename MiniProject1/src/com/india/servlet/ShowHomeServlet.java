...
@WebServlet("/showhome.jlc")
public class ShowHomeServlet extends HttpServlet{
	
	@Override
	protected void service(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		System.out.println("service() Of ShowHomeServlet started...");
		...
		RequestDispatcher rd3=req.getRequestDispatcher("/WEB-INF/home.html"); rd3.include(req, res);
		RequestDispatcher rd4=req.getRequestDispatcher("/WEB-INF/footer.html"); rd4.include(req, res);
		
		System.out.println("service() Of ShoeHomeServlet completed...");
	}
