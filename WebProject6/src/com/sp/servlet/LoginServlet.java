...
public class LoginServlet extends HttpServlet{
	...
	public void init(ServletConfig config) throws ServletException {
		...
		System.out.println("Value from context parameter..");
		context=config.getServletContext();
		System.out.println("Website :"+context.getInitParameter("website")+" ,College Name :"+context.getInitParameter("collegeName"));
		
	}
	
	@Override
	public void service(HttpServletRequest req ,HttpServletResponse res) throws IOException {
		System.out.println("Vallue from Context Parameter..");
		System.out.println("Website :"+context.getInitParameter("website")+" ,College Name :"+context.getInitParameter("collegeName"));
